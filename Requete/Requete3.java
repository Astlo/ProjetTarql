...
public class Requete3 {
    ...
    public static void main (String args[]) {
        ...
        String queryString = "SELECT ?anneeDebut ?pays (SUM(?money2) AS ?somme) (AVG(?money2) AS ?moyenne) { "
	    			...
	    			+ "} UNION {"
	    				+ "GRAPH ?g {"
							+ "?x <http://www.w3.org/2000/01/rdf-schema#type> <http://usefulinc.com/ns/doap#Project>;"
							+ "<http://purl.org/cerif/frapo/BudgetedAmount> ?money;"
		    				+ "<https://www.w3.org/ns/org#linkedTo> ?y;"
	    					+ "<https://www.w3.org/2006/time#hasBeginning> ?anneeDebut."
							+ "?y <http://www.w3.org/2000/01/rdf-schema#type> <http://usefulinc.com/ns/doap#projectParticipant>;"
	    					+ "<http://dbpedia.org/ontology/locationCountry> ?pays;"
	    					+ "<https://www.w3.org/2006/time#hasBeginning> ?anneeDebut."
		                    + "BIND(<http://www.w3.org/2001/XMLSchema#float>(?money) AS ?money2)"
	    				+ "}"
